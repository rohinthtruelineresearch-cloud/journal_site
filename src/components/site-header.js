      ...
      <div className="flex items-center justify-between gap-4 px-6 py-4 md:px-10 lg:px-16">
        ...
        <div className="flex items-center gap-3">
           <Link
                ...
                className="group hidden xl:flex items-center justify-center rounded-full bg-green-500 p-2 text-white shadow-lg shadow-green-500/20 transition-all duration-300 ease-in-out hover:px-4 hover:bg-green-600"
              >
                <svg
                ...
                <span className="max-w-0 overflow-hidden whitespace-nowrap pl-0 text-xs font-semibold text-white transition-all duration-300 ease-in-out group-hover:max-w-xs group-hover:pl-2">
                  Join community
                </span>
          </Link>
          {user ? (
